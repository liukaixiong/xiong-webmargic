...
//    public static final String BASE_Node_URL = "http://www.toutiao.com/search/?keyword=%E5%91%A8%E6%9D%B0%E4%BC%A6";
    ...
    public ProxyIPProcessor(String url) {
        this.url = url;
    }
    ...
    public void process(Page page) {
        List<String> ipList = page.getHtml().xpath("//*[@id=\"index_free_list\"]/table/tbody/tr/td[1]/text()").all();
        List<String> portList = page.getHtml().xpath("//*[@id=\"index_free_list\"]/table/tbody/tr/td[2]/text()").all();
        int successCount = 0;
        int errorCount = 0;
        ...
        page.addTargetRequest("http://www.kuaidaili.com/proxylist/" + index);
