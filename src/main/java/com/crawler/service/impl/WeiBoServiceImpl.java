...
import com.crawler.dao.WbCommentsMapper;
import com.crawler.dao.WbReplyMapper;
import com.crawler.dao.WbTopicMapper;
...
import com.crawler.webmargic.WeiBoProcessor;
...
//    }
    ...
    public ResultDTO crawler(RequestTaskModel requestModel) throws Exception {
        Spider.create(new WeiBoProcessor(this, requestModel, username, password)).addUrl(requestModel.getUrl()).thread(5).run();
        return ResultDTO.isOK(null);
    }
